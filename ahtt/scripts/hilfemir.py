...
combine_help_messages = {
    ...
    "--seed": "random seed to be used for rng related things. give 0 to read from machine. negative values to use no rng in make_datacard, and a default reproducible seed elsewhere.",
    ...
    "please use --toy-location to load the 0,0 toys\n"
...
submit_help_messages = {
    ...
    "or 'random', which runs over random points around a chosen g1, g2 point (best fit by default).",
